...
//309026/1717324/2.50/8/0/Integrated Circuit
...
(library Library_1
	...
	(symbolDef "TCAN332DR" (originalName "TCAN332DR")
	...
	(compDef "TCAN332DR" (originalName "TCAN332DR") (compHeader (numPins 8) (numParts 1) (refDesPrefix IC)
		)
		...
		(compPin "5" (pinName "NC_1") (partNum 1) (symPinNum 8) (gateEq 0) (pinEq 0) (pinType Unknown))
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "TCAN332DR"))
		...
		(attr "Manufacturer_Part_Number" "TCAN332DR")
		(attr "Mouser Part Number" "595-TCAN332DR")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Texas-Instruments/TCAN332DR?qs=n%252BTO0c4TDSYIUeM9WmVMtA%3D%3D")
		(attr "Arrow Part Number" "TCAN332DR")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/tcan332dr/texas-instruments?region=nac")
		(attr "Description" "TEXAS INSTRUMENTS - TCAN332DR - CAN TRANSCEIVER, 5MBPS, SOIC-8")
		(attr "<Hyperlink>" "http://www.ti.com/lit/ds/symlink/tcan332.pdf")
		(attr "<Component Height>" "1.75")
		(attr "<STEP Filename>" "TCAN332DR.stp")
