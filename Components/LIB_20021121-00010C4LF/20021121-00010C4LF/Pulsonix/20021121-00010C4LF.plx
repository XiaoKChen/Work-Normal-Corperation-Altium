...
(library Library_1
	...
	(patternDef "2002112100010C4LF" (originalName "2002112100010C4LF")
		...
		(layerContents (layerNumRef 28)
			(line (pt -2.54 2.1) (pt 2.54 2.1) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 2.54 2.1) (pt 2.54 -2.1) (width 0.025))
		)
	...
	(compDef "20021121-00010C4LF" (originalName "20021121-00010C4LF") (compHeader (numPins 10) (numParts 1) (refDesPrefix J)
		...
		(attr "<Hyperlink>" "https://cdn.amphenol-cs.com/media/wysiwyg/files/drawing/20021121.pdf")
		(attr "<Component Height>" "5.7")
		(attr "<STEP Filename>" "20021121-00010C4LF.stp")
		(attr "<STEP Offsets>" "X=-2.54;Y=0;Z=0.4")
