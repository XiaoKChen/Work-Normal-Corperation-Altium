...
//251150/1717324/2.50/3/2/MOSFET N-Channel
...
(library Library_1
	...
	(patternDef "SOT65P222X110-3N" (originalName "SOT65P222X110-3N")
		(multiLayer
			(pad (padNum 1) (padStyleRef r110_50) (pt -1, 0.65) (rotation 90))
			(pad (padNum 2) (padStyleRef r110_50) (pt -1, -0.65) (rotation 90))
			(pad (padNum 3) (padStyleRef r110_50) (pt 1, 0) (rotation 90))
		)
		...
		(layerContents (layerNumRef 18)
			(line (pt -1.55 1.15) (pt -0.45 1.15) (width 0.2))
		)
	)
	(symbolDef "DMG1012UW-7" (originalName "DMG1012UW-7")
	...
	(compDef "DMG1012UW-7" (originalName "DMG1012UW-7") (compHeader (numPins 3) (numParts 1) (refDesPrefix Q)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "DMG1012UW-7"))
		(attachedPattern (patternNum 1) (patternName "SOT65P222X110-3N")
			(numPads 3)
			(padPinMap
		...
		(attr "Manufacturer_Part_Number" "DMG1012UW-7")
		(attr "Mouser Part Number" "621-DMG1012UW-7")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Diodes-Incorporated/DMG1012UW-7?qs=vIZ3oKQCLxp8XxWFc0YBWg%3D%3D")
		(attr "Arrow Part Number" "DMG1012UW-7")
		(attr "Arrow Price/Stock" "https://www.arrow.com/en/products/dmg1012uw-7/diodes-incorporated?utm_currency=USD&region=europe")
		(attr "Description" "MOSFET N-Channel 20V 1A SOT323 Diodes Inc DMG1012UW-7 N-channel MOSFET Transistor, 1 A, 20 V, 3-Pin SOT-323")
		(attr "<Hyperlink>" "https://www.diodes.com//assets/Datasheets/DMG1012UW.pdf")
		(attr "<Component Height>" "1.1")
		(attr "<STEP Filename>" "DMG1012UW-7.stp")
